  ...
  function ensureRuntimeCssInjected() {
    ...
    style.textContent =
      '@media (min-width: 769px){' +
        ...
        'html[dir="ltr"] .nav-container > .nav-ecommerce-icons.nav-icons-left,body[dir="ltr"] .nav-container > .nav-ecommerce-icons.nav-icons-left,html[dir="ltr"] .nav-right-group > .nav-ecommerce-icons.nav-icons-left,body[dir="ltr"] .nav-right-group > .nav-ecommerce-icons.nav-icons-left{margin-inline-start:auto!important;flex-shrink:1!important;min-width:0!important}' +
        'html[dir="ltr"] .nav-right-group .nav-search-box,html[dir="ltr"] .nav-container .nav-search-box{flex:0 1 150px!important;min-width:80px!important}' +
        'html[dir="ltr"] .nav-right-group .nav-search-box input,html[dir="ltr"] .nav-container .nav-search-box input{min-width:0!important;width:100%!important}' +
