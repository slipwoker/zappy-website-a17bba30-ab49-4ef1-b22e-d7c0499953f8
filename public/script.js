document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field, errorType) {
      const label =
      ...
      return messages[errorType] || label + ' is invalid.';
    };
    ...
    contactForm.addEventListener('input', function (e) {
      const field = e.target.closest('input, textarea, select');
      if (field && field.classList.contains('is-invalid') && contactForm.contains(field)) {
        validateField(field);
      }
    });
  }
  ...
  const OBSERVED_CLASS = 'fade-in-element';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '30aa8b51-0129-4b18-97a7-1ceb60d56ea2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '30aa8b51-0129-4b18-97a7-1ceb60d56ea2';
...
/* Integration Scripts */
// setup_contact_form_emails functionality
// Email integration configured for גורים בכפר
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '30aa8b51-0129-4b18-97a7-1ceb60d56ea2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a17bba30-ab49-4ef1-b22e-d7c0499953f8';
  ...
  function ensureRuntimeCssInjected() {
    ...
    style.textContent =
      '@media (min-width: 769px){' +
        ...
        'html[dir="ltr"] .nav-container > .nav-menu,body[dir="ltr"] .nav-container > .nav-menu,html[dir="ltr"] .nav-right-group > .nav-menu,body[dir="ltr"] .nav-right-group > .nav-menu{order:1!important;margin-inline-start:0!important;margin-inline-end:24px!important;flex:0 1 auto!important}' +
        ...
        'html[dir="ltr"] .nav-container > .nav-ecommerce-icons.nav-icons-left,body[dir="ltr"] .nav-container > .nav-ecommerce-icons.nav-icons-left,html[dir="ltr"] .nav-right-group > .nav-ecommerce-icons.nav-icons-left,body[dir="ltr"] .nav-right-group > .nav-ecommerce-icons.nav-icons-left{margin-inline-start:auto!important}' +
